...
class EA(nn.Module):
    def __init__(self, history_dim, obs_dim, output_dim, *args, **kwargs):
        super(EA, self).__init__(*args, **kwargs)
...
class BackBone(nn.Module):
    def __init__(self, history_dim, lidar_dim, kin_input_dim, kin_output_dim, hidden_dim, n_history_frame, n_waypoints,*args, **kwargs):
        ...
        self.ea = EA(history_dim, lidar_dim, kin_output_dim)
    ...
    def forward(self, observation:torch.Tensor):
        ...
        Returns:
            ...
            through dedicated network modules (EA, kinetic_model), integrating them via multi-head attention,
        ...
        env_rep = self.ea.forward(lidar_observation, current_lidar)
