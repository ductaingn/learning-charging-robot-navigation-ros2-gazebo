...
def generate_launch_description():
    ...
    fws_robot_sim_path = get_package_share_directory('fws_robot_sim')
    ...
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        arguments=['-d', PathJoinSubstitution([fws_robot_sim_path, 'config', LaunchConfiguration('rviz_config')])],
